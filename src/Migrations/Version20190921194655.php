 ...
 */
final class Version20190921194655 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE logs (id INT AUTO_INCREMENT NOT NULL, request LONGTEXT NOT NULL, response LONGTEXT NOT NULL, createdAt DATETIME NOT NULL, updatedAt DATETIME DEFAULT NULL, deletedAt DATETIME DEFAULT NULL, status ENUM(\'new\', \'active\', \'inactive\', \'deleted\') DEFAULT \'new\' NOT NULL COMMENT \'(DC2Type:enum_status_default)\', authorId INT DEFAULT NULL, INDEX IDX_F08FC65CA196F9FD (authorId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE notifications (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(10) NOT NULL, createdAt DATETIME NOT NULL, updatedAt DATETIME DEFAULT NULL, deletedAt DATETIME DEFAULT NULL, status ENUM(\'new\', \'active\', \'inactive\', \'deleted\') DEFAULT \'new\' NOT NULL COMMENT \'(DC2Type:enum_status_default)\', authorId INT DEFAULT NULL, userId INT NOT NULL, productId VARCHAR(14) DEFAULT NULL, INDEX IDX_6000B0D3A196F9FD (authorId), INDEX IDX_6000B0D364B64DCC (userId), INDEX IDX_6000B0D336799605 (productId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
