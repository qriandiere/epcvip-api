 ...
 */
final class Version20190921115957 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tokens (id INT AUTO_INCREMENT NOT NULL, value VARCHAR(255) NOT NULL, type VARCHAR(10) NOT NULL, createdAt DATETIME NOT NULL, updatedAt DATETIME DEFAULT NULL, deletedAt DATETIME DEFAULT NULL, status ENUM(\'new\', \'active\', \'inactive\', \'deleted\') NOT NULL COMMENT \'(DC2Type:enum_status_default)\', userId INT NOT NULL, INDEX IDX_AA5A118E64B64DCC (userId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tokens ADD CONSTRAINT FK_AA5A118E64B64DCC FOREIGN KEY (userId) REFERENCES users (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tokens DROP FOREIGN KEY FK_AA5A118E64B64DCC');
